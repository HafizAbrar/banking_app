...
class ElectricBillPaymentConfirmationScreen extends StatelessWidget {

  const ElectricBillPaymentConfirmationScreen({super.key});
  @override
        ...
        child: Column(
          ...
          children: [
            ...
            Padding(
              ...
              child: Text('You have successfully paid your electricity bill!',
                style:TextStyle(
                  color: Colors.black,
                  fontSize: 14,
                ),),
