...
class GasBillPaymentScreen extends StatefulWidget {
  final String referenceNumber;

  const GasBillPaymentScreen({super.key, required this.referenceNumber});

  @override
  State<GasBillPaymentScreen> createState() => _GasBillPaymentScreenState();
}

class _GasBillPaymentScreenState extends State<GasBillPaymentScreen> {
