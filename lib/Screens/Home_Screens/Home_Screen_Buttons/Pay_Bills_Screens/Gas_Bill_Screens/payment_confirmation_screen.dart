...
class GasBillPaymentConfirmationScreen extends StatelessWidget {

  const GasBillPaymentConfirmationScreen({super.key});
  @override
        ...
        child: Column(
          ...
          children: [
            ...
            Padding(
              ...
              child: Text('You have successfully paid your gas bill!',
                style:TextStyle(
                  color: Colors.black,
                  fontSize: 14,
                ),),
