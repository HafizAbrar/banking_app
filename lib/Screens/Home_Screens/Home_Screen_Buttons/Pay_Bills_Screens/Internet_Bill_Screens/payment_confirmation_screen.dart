...
class InternetBillPaymentConfirmationScreen extends StatelessWidget {

  const InternetBillPaymentConfirmationScreen({super.key});
  @override
        ...
        child: Column(
          ...
          children: [
            ...
            Padding(
              ...
              child: Text('You have successfully paid your Internet bill!',
                style:TextStyle(
                  color: Colors.black,
                  fontSize: 14,
                ),),
