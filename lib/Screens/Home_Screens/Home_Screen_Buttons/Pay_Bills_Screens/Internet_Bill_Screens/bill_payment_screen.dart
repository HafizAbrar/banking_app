...
class InternetBillPaymentScreen extends StatefulWidget {
  final String referenceNumber;

  const InternetBillPaymentScreen({super.key, required this.referenceNumber});

  @override
  State<InternetBillPaymentScreen> createState() => _InternetBillPaymentScreenState();
}

class _InternetBillPaymentScreenState extends State<InternetBillPaymentScreen> {
