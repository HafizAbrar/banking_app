...
class MobileBillPaymentConfirmationScreen extends StatelessWidget {

  const MobileBillPaymentConfirmationScreen({super.key});
  @override
        ...
        child: Column(
          ...
          children: [
            ...
            Padding(
              ...
              child: Text('You have successfully paid your Mobile bill!',
                style:TextStyle(
                  color: Colors.black,
                  fontSize: 14,
                ),),
