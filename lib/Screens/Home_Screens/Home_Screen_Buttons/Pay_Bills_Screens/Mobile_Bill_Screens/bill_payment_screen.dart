...
import 'package:mobile_banking/Screens/Home_Screens/Home_Screen_Buttons/Pay_Bills_Screens/Mobile_Bill_Screens/payment_confirmation_screen.dart';
import '../../../../../Common_Widgets/custom_textfield.dart';

class MobileBillPaymentScreen extends StatefulWidget {
  final String referenceNumber;

  const MobileBillPaymentScreen({super.key, required this.referenceNumber});

  @override
  State<MobileBillPaymentScreen> createState() => _MobileBillPaymentScreenState();
}

class _MobileBillPaymentScreenState extends State<MobileBillPaymentScreen> {
            ...
            SizedBox(
              ...
              child: ElevatedButton(
                onPressed:_isFormValid? () {
                  Navigator.push(
                    context,
                    MaterialPageRoute(builder: (context) => MobileBillPaymentConfirmationScreen()),
                  );
                }:null,
                style: ElevatedButton.styleFrom(
