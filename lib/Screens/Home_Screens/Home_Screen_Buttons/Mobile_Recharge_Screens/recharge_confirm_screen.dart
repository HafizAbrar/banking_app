...
import 'package:mobile_banking/Screens/Home_Screens/Home_Screen_Buttons/Mobile_Recharge_Screens/recharge_success_screen.dart';
import 'package:mobile_banking/Screens/Home_Screens/Home_Screen_Buttons/Withdraw/confirm_withdraw_screen.dart';
import '../../../../Common_Widgets/custom_textfield.dart';

enum AuthMethod { none, fingerprint, faceScan, pin }
AuthMethod selectedMethod = AuthMethod.none;

class ConfirmRechargeScreen extends StatefulWidget {
  final String senderAccount;
  final String beneficiaryAccount;
  final double amount;

  const ConfirmRechargeScreen({
    super.key,
  ...
  @override
  State<ConfirmRechargeScreen> createState() => _ConfirmRechargeScreenState();
}

class _ConfirmRechargeScreenState extends State<ConfirmRechargeScreen> {
  ...
  void initState() {
    super.initState();
    _senderCardNumberController.text = widget.senderAccount.toString();
        ...
        child: Padding(
          ...
          child: Column(
            ...
            children: [
              ...
              SizedBox(height: 10,),
              Text('Available balance is \R\S 10,000',
                style: TextStyle(
                    fontSize: 14,
              ...
              const SizedBox(height: 10),
              _sectionLabel('To'),
              CustomTextField(controller: _receiverAccountNumberController, hintText: 'Name', keyboardType: TextInputType.text),
              const SizedBox(height: 10),
        ...
        child: ElevatedButton(
          ...
          onPressed: isConfirmEnabled
            ...
            Navigator.push(
              context,
              MaterialPageRoute(
                builder: (context) => RechargeConfirmationScreen(
                    beneficiaryNumber: _receiverAccountNumberController.text,
